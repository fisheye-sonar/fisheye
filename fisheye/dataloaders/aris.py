...
class ARISBatchedDataset(BaseDataset):
    ...
    def __init__(self, aris_filepath, beam_width_dir=BEAM_WIDTH_DIR, annotations_file=None, batch_size=32, num_frames_bg_subtract=1000,
        ...
        super().__init__(start_frame, end_frame, xdim, ydim, beam_width_dir, annotations_file, batch_size,
                         num_frames_bg_subtract,
                         disable_output, cache_bg_frames, do_bg_subtract)
...
def create_aris_dataloader(aris_filepath, beam_width_dir=BEAM_WIDTH_DIR, annotations_file=None, batch_size=32,
                           rank=-1, world_size=1, workers=0, disable_output=False, cache_bg_frames=False,
                           do_bg_subtract=True):
    """
    ...
    with torch_distributed_zero_first(rank):
        dataset = ARISBatchedDataset(aris_filepath, beam_width_dir, annotations_file, batch_size=batch_size,
