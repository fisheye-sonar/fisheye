...
def to_txt(data, out_dir, upstream_direction: str = "left"):
            ...
            for _, row in group_df_sorted.iterrows():
                ...
                if has_data:
                    row_data = {
                        ...
                        "Dir": (
                            "Up"
                            if row.get("direction") == upstream_direction
                            else "Down"
                        ),
                        "R (m)": row["distance"],
                        "Theta": row["theta"],
...
def save_to_disk(
    ...
    for export_option in export_types:
        ...
        if export_option in [ExportType.DETAILED_CSV, ExportType.SUMMARY_CSV]:
            ...
            exporter(results, output_dir, upstream_direction=upstream_direction)
