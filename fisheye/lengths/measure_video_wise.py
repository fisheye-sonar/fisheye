...
def get_pred_from_video_wise(
    ...
    with torch.no_grad():
        for frame_crop_info in tqdm(crop_info):
            ...
            # MAH 2025-11-24 18:48:13 this should all be batched together to save time a get_item_ that can pull in multiple frames at once and cache them , likely a 3x speed increase
...
def get_pred_from_video_wise_helper(
    frames_preds,
    metadata,
    ...
    pred_len_outputs = get_pred_from_video_wise(
        crop_info,
        dataset,
        model,
        crop_after_model,
